...
/* UARTB */
#define CSR_UARTB_BASE (CSR_BASE + 0x0L)
#define CSR_UARTB_BAUDIOS_ADDR (CSR_BASE + 0x0L)
...
#define CSR_UARTB_TXINIT_ADDR (CSR_BASE + 0x4L)
...
#define CSR_UARTB_TXDATA_ADDR (CSR_BASE + 0x8L)
...
#define CSR_UARTB_EV_STATUS_ADDR (CSR_BASE + 0x18L)
...
#define CSR_UARTB_EV_PENDING_ADDR (CSR_BASE + 0x1cL)
...
#define CSR_UARTB_EV_ENABLE_ADDR (CSR_BASE + 0x20L)
...
/* UARTA */
#define CSR_UARTA_BASE (CSR_BASE + 0x800L)
#define CSR_UARTA_BAUDIOS_ADDR (CSR_BASE + 0x800L)
...
#define CSR_UARTA_TXINIT_ADDR (CSR_BASE + 0x804L)
...
#define CSR_UARTA_TXDATA_ADDR (CSR_BASE + 0x808L)
...
#define CSR_UARTA_EV_STATUS_ADDR (CSR_BASE + 0x818L)
...
#define CSR_UARTA_EV_PENDING_ADDR (CSR_BASE + 0x81cL)
...
#define CSR_UARTA_EV_ENABLE_ADDR (CSR_BASE + 0x820L)
...
/* SERVO */
#define CSR_SERVO_BASE (CSR_BASE + 0x1000L)
#define CSR_SERVO_PERIODO_ADDR (CSR_BASE + 0x1000L)
#define CSR_SERVO_PERIODO_SIZE 1
static inline uint32_t SERVO_Periodo_read(void) {
	return csr_read_simple(CSR_BASE + 0x1000L);
}
static inline void SERVO_Periodo_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1000L);
}
#define CSR_SERVO_CICLO_ADDR (CSR_BASE + 0x1004L)
#define CSR_SERVO_CICLO_SIZE 1
static inline uint32_t SERVO_Ciclo_read(void) {
	return csr_read_simple(CSR_BASE + 0x1004L);
}
static inline void SERVO_Ciclo_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1004L);
}

/* INF */
#define CSR_INF_BASE (CSR_BASE + 0x1800L)
#define CSR_INF_DATAIN_ADDR (CSR_BASE + 0x1800L)
#define CSR_INF_DATAIN_SIZE 1
static inline uint32_t INF_Datain_read(void) {
	return csr_read_simple(CSR_BASE + 0x1800L);
}
static inline void INF_Datain_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1800L);
}
#define CSR_INF_CONTROL_ADDR (CSR_BASE + 0x1804L)
#define CSR_INF_CONTROL_SIZE 1
static inline uint32_t INF_Control_read(void) {
	return csr_read_simple(CSR_BASE + 0x1804L);
}
static inline void INF_Control_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1804L);
}
#define CSR_INF_DATAOUT_ADDR (CSR_BASE + 0x1808L)
#define CSR_INF_DATAOUT_SIZE 1
static inline uint32_t INF_Dataout_read(void) {
	return csr_read_simple(CSR_BASE + 0x1808L);
}
#define CSR_INF_EV_STATUS_ADDR (CSR_BASE + 0x180cL)
#define CSR_INF_EV_STATUS_SIZE 1
static inline uint32_t INF_ev_status_read(void) {
	return csr_read_simple(CSR_BASE + 0x180cL);
}
#define CSR_INF_EV_STATUS_REFLECT_OFFSET 0
#define CSR_INF_EV_STATUS_REFLECT_SIZE 1
static inline uint32_t INF_ev_status_reflect_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t INF_ev_status_reflect_read(void) {
	uint32_t word = INF_ev_status_read();
	return INF_ev_status_reflect_extract(word);
}
#define CSR_INF_EV_PENDING_ADDR (CSR_BASE + 0x1810L)
#define CSR_INF_EV_PENDING_SIZE 1
static inline uint32_t INF_ev_pending_read(void) {
	return csr_read_simple(CSR_BASE + 0x1810L);
}
static inline void INF_ev_pending_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1810L);
}
#define CSR_INF_EV_PENDING_REFLECT_OFFSET 0
#define CSR_INF_EV_PENDING_REFLECT_SIZE 1
static inline uint32_t INF_ev_pending_reflect_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t INF_ev_pending_reflect_read(void) {
	uint32_t word = INF_ev_pending_read();
	return INF_ev_pending_reflect_extract(word);
}
static inline uint32_t INF_ev_pending_reflect_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void INF_ev_pending_reflect_write(uint32_t plain_value) {
	uint32_t oldword = INF_ev_pending_read();
	uint32_t newword = INF_ev_pending_reflect_replace(oldword, plain_value);
	INF_ev_pending_write(newword);
}
#define CSR_INF_EV_ENABLE_ADDR (CSR_BASE + 0x1814L)
#define CSR_INF_EV_ENABLE_SIZE 1
static inline uint32_t INF_ev_enable_read(void) {
	return csr_read_simple(CSR_BASE + 0x1814L);
}
static inline void INF_ev_enable_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1814L);
}
#define CSR_INF_EV_ENABLE_REFLECT_OFFSET 0
#define CSR_INF_EV_ENABLE_REFLECT_SIZE 1
static inline uint32_t INF_ev_enable_reflect_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t INF_ev_enable_reflect_read(void) {
	uint32_t word = INF_ev_enable_read();
	return INF_ev_enable_reflect_extract(word);
}
static inline uint32_t INF_ev_enable_reflect_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void INF_ev_enable_reflect_write(uint32_t plain_value) {
	uint32_t oldword = INF_ev_enable_read();
	uint32_t newword = INF_ev_enable_reflect_replace(oldword, plain_value);
	INF_ev_enable_write(newword);
}

/* ULTRASONIDO */
#define CSR_ULTRASONIDO_BASE (CSR_BASE + 0x2000L)
#define CSR_ULTRASONIDO_INICIO_ADDR (CSR_BASE + 0x2000L)
#define CSR_ULTRASONIDO_INICIO_SIZE 1
static inline uint32_t ULTRASONIDO_Inicio_read(void) {
	return csr_read_simple(CSR_BASE + 0x2000L);
}
static inline void ULTRASONIDO_Inicio_write(uint32_t v) {
...
#define CSR_ULTRASONIDO_DISTANCIA_ADDR (CSR_BASE + 0x2008L)
...
#define CSR_ULTRASONIDO_EV_STATUS_ADDR (CSR_BASE + 0x200cL)
#define CSR_ULTRASONIDO_EV_STATUS_SIZE 1
static inline uint32_t ULTRASONIDO_ev_status_read(void) {
	return csr_read_simple(CSR_BASE + 0x200cL);
}
#define CSR_ULTRASONIDO_EV_STATUS_DONE_OFFSET 0
#define CSR_ULTRASONIDO_EV_STATUS_DONE_SIZE 1
static inline uint32_t ULTRASONIDO_ev_status_done_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t ULTRASONIDO_ev_status_done_read(void) {
	uint32_t word = ULTRASONIDO_ev_status_read();
	return ULTRASONIDO_ev_status_done_extract(word);
}
#define CSR_ULTRASONIDO_EV_PENDING_ADDR (CSR_BASE + 0x2010L)
#define CSR_ULTRASONIDO_EV_PENDING_SIZE 1
static inline uint32_t ULTRASONIDO_ev_pending_read(void) {
	return csr_read_simple(CSR_BASE + 0x2010L);
}
static inline void ULTRASONIDO_ev_pending_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x2010L);
}
#define CSR_ULTRASONIDO_EV_PENDING_DONE_OFFSET 0
#define CSR_ULTRASONIDO_EV_PENDING_DONE_SIZE 1
static inline uint32_t ULTRASONIDO_ev_pending_done_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t ULTRASONIDO_ev_pending_done_read(void) {
	uint32_t word = ULTRASONIDO_ev_pending_read();
	return ULTRASONIDO_ev_pending_done_extract(word);
}
static inline uint32_t ULTRASONIDO_ev_pending_done_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void ULTRASONIDO_ev_pending_done_write(uint32_t plain_value) {
	uint32_t oldword = ULTRASONIDO_ev_pending_read();
	uint32_t newword = ULTRASONIDO_ev_pending_done_replace(oldword, plain_value);
	ULTRASONIDO_ev_pending_write(newword);
}
#define CSR_ULTRASONIDO_EV_ENABLE_ADDR (CSR_BASE + 0x2014L)
#define CSR_ULTRASONIDO_EV_ENABLE_SIZE 1
static inline uint32_t ULTRASONIDO_ev_enable_read(void) {
	return csr_read_simple(CSR_BASE + 0x2014L);
}
static inline void ULTRASONIDO_ev_enable_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x2014L);
}
#define CSR_ULTRASONIDO_EV_ENABLE_DONE_OFFSET 0
#define CSR_ULTRASONIDO_EV_ENABLE_DONE_SIZE 1
static inline uint32_t ULTRASONIDO_ev_enable_done_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t ULTRASONIDO_ev_enable_done_read(void) {
	uint32_t word = ULTRASONIDO_ev_enable_read();
	return ULTRASONIDO_ev_enable_done_extract(word);
}
static inline uint32_t ULTRASONIDO_ev_enable_done_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void ULTRASONIDO_ev_enable_done_write(uint32_t plain_value) {
	uint32_t oldword = ULTRASONIDO_ev_enable_read();
	uint32_t newword = ULTRASONIDO_ev_enable_done_replace(oldword, plain_value);
	ULTRASONIDO_ev_enable_write(newword);
}

/* MOTORES */
#define CSR_MOTORES_BASE (CSR_BASE + 0x2800L)
#define CSR_MOTORES_MOVIMIENTO_ADDR (CSR_BASE + 0x2800L)
...
#define CSR_MOTORES_DUTY1_ADDR (CSR_BASE + 0x2804L)
#define CSR_MOTORES_DUTY1_SIZE 1
static inline uint32_t MOTORES_Duty1_read(void) {
	return csr_read_simple(CSR_BASE + 0x2804L);
}
static inline void MOTORES_Duty1_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x2804L);
}
#define CSR_MOTORES_DUTY2_ADDR (CSR_BASE + 0x2808L)
#define CSR_MOTORES_DUTY2_SIZE 1
static inline uint32_t MOTORES_Duty2_read(void) {
	return csr_read_simple(CSR_BASE + 0x2808L);
}
static inline void MOTORES_Duty2_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x2808L);
}

/* VGA_Mapa */
#define CSR_VGA_MAPA_BASE (CSR_BASE + 0x3000L)
#define CSR_VGA_MAPA_FORMA_ADDR (CSR_BASE + 0x3000L)
#define CSR_VGA_MAPA_FORMA_SIZE 1
static inline uint32_t VGA_Mapa_Forma_read(void) {
	return csr_read_simple(CSR_BASE + 0x3000L);
}
#define CSR_VGA_MAPA_PROMEDIOCOLOR_ADDR (CSR_BASE + 0x3004L)
...
#define CSR_VGA_MAPA_MAPADATA_ADDR (CSR_BASE + 0x3008L)
...
#define CSR_VGA_MAPA_MAPAADDR_ADDR (CSR_BASE + 0x300cL)
...
#define CSR_VGA_MAPA_MAPAWRITE_ADDR (CSR_BASE + 0x3010L)
